...
Innkommende forespørsler valideres i Astro-middleware (`src/middleware.ts`) med `@navikt/oasis`. Mot `tms-utkast` veksles brukerens token til et on-behalf-of-token via TokenX før utkast hentes.
